...
class _SignInPageState extends State<SignInPage> {
  ...
  Future<void> _signInWithEmail() async {
    ...
    try {
      ...
      // Dispatch event to AuthBloc for email sign-in
      BlocProvider.of<AuthBloc>(context).add(
        EmailSignInRequested(email: emailController.text, password: passwordController.text),
      );
    } catch (e) {
                  ...
                  child: Padding(
                    ...
                    child: _isLoading
                      ...
                      children: [
                        ...
                        if (_errorMessage.isNotEmpty)
                          Padding(
                            padding: EdgeInsets.symmetric(vertical: 10.0, horizontal: defaultPadding),
